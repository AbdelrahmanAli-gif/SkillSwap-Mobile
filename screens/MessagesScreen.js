...
const MessagesScreen = () => {
    ...
    return (
        <View className="flex-1 px-5 pt-5" style={{ direction: isRTL ? 'rtl' : 'ltr', marginTop: 30 }}>
            <GradientBackground />
            <Text className="font-bold mb-2 text-3xl text-main-color-light dark:text-main-color-dark">{t("MessagesScreen.title")}</Text>
            <Text className="text-sm text-text-secondary-light dark:text-text-secondary-dark">{t("MessagesScreen.description")}</Text>

            <View className="w-full h-12 flex-row border-b border-b-slate-500">
